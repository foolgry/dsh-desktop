...
1. **Bundles a Node runtime.** It uses the Node.js that ships inside Electron, plus the officially published [`@deepseek-ai/dsh`](https://www.npmjs.com/package/@deepseek-ai/dsh) package — nothing is installed on your system.
